...
public class Constants {
	...
	public interface MensajeBienvenida{
		public static String MENSAJE="Bienvenido al Juego The Pooglins. El juego consiste en tratar \n" +
									"de llevar los pooglins de la nave de entrada a la nave de salida. \n" +
									"Para ello el poogling debe atravesar diferentes tipos de obstaculos, \n"+
									"y como ayuda este tendra una serie de habilidades. La habilidad se aplica \n"+
									"sobre el poogling seleccionando previamente el boton de la habilidad a \n"+
									"aplicarle: Rayo laser, Taladro ultrasonico, Tunel electromagnetico, \n" +
									"Platillo volador, Congelamiento y Teletransportacion. Luego de hacer click \n" +
									"sobre dicho boton se tendra que hacer click en el poogling por el cual quiero \n"+
									"aplicarle dicha Habilidad. \n"+"\n GRUPO Nº40 \n"+"        Integrantes: Cecilia Barbalarga, \n"+
									"        Santiago Rocha, \n"+"        Pablo Sívori"+"\n \n        Ayudante: Eugenio Yolis";
