...
public class PlatilloVolador extends Habilidad{
	...
	public void aplicarApooglin(Mapa mapa, Poogling poogling,Terreno terreno) {
		...
		if( terreno.isTraspasable()&&terreno.obtenerPosicion().compareTo(poogling.obtenerPosicion().obtenerPosicionSiguienteAbajo())==Constants.ValorComparador.IGUAL){
	...
	public void aplicarAterreno(Mapa mapa, Terreno terreno, Poogling poogling) {
		...
		//El platillo volador no aplica ninguna accion sobre el terreno
	}
