...
public class PruebaPooglinAlVacio extends TestCase{
	...
	public void testPooglinAlVacio(){
		...
		assertEquals(true,colPooglins.estaVacia()); //el poogling no pudo llegar a la nave de salida porque se murio al caer al vacio
	}												//esto paso por no aplicarle la habilidad platillo volador	
