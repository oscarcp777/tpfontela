...
public class PruebaCrearTunel extends TestCase {
	...
	protected void setUp() throws Exception{
		...
		ContenedorHabilidades contenedor = ContenedorHabilidades.getInstance();
	...
	public void testCreacionDeTunelYMovimientoPooglin(){
		...
		assertEquals(false,colPooglins.estaVacia()); //llego a la nave de salida, aplicando la habilidad tunelElectromagnetico
	}
