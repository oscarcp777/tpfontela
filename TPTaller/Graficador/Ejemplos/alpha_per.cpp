...
{
	SDL_Surface *screen, *imagen, *lente, *circulo_key, *temp;
	SDL_Rect ori, dest;
	...
	SDL_SetAlpha (temp, SDL_SRCALPHA | SDL_RLEACCEL, 128);

	circulo_key = SDL_DisplayFormatAlpha(temp);
