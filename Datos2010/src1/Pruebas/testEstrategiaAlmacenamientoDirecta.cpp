/*
 * testEstrategiaAlmacenamientoDirecta.cpp
 *
 *  Created on: 01/11/2009
 *      Author: richy
 */

#include "testEstrategiaAlmacenamientoDirecta.h"
#include "Pruebas.h"

testEstrategiaAlmacenamientoDirecta::testEstrategiaAlmacenamientoDirecta() {
...
void testEstrategiaAlmacenamientoDirecta::correrTest(){
	/**
		...
		RecursoDeAlmacenamiento* recurso=
				fabricaDeRecursos->crearRecursoDeAlmacenamientoEnArchivoConBuffer(ESTRATEGIA_ALMACENAMIENTO_TEXTO,50,
						"../TP0Datos/files/",30,"archivoTextoDirecta","Padron",INDEXADO_BSHARP,alumno);
