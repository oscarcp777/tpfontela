...
//		int recaddr = this->search(oldKey,recAddr);
	...
	int  init(int maxSize){
		...
		//tama̱o del bloque ocupado con datos de metadata del bloque, se resta al freeSpace en este init
		//tama̱o n.keys + n.keys + tama̱o espacio libre + espacio libre + tama̱o nod.sig. + nod.sig
