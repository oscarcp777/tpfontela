/*
 * TestGuardarComoArchivoRegistros.cpp
 *
 *  Created on: 01/11/2009
 *      Author: oscar
 */

#include "TestGuardarComoArchivoRegistros.h"

TestGuardarComoArchivoRegistros::TestGuardarComoArchivoRegistros() {
...
void TestGuardarComoArchivoRegistros::ejecutarTest(){
	/**
			...
			RecursoDeAlmacenamiento* recurso=
					fabricaDeRecursos->crearRecursoDeAlmacenamientoEnArchivo(ESTRATEGIA_ALMACENAMIENTO_REGISTROS,40,
							this->getRuta(),"archivoRegistros","Padron",INDEXADO_BSHARP,alumno);
