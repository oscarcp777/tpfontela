/*
 * EjemploArchivoRegistros.cpp
 *
 *  Created on: 02/10/2009
 *      Author: oscar
 */

#include "EjemploArchivoRegistros.h"
using namespace std;
EjemploArchivoRegistros::EjemploArchivoRegistros() {
...
void EjemploArchivoRegistros::crear(ArchivoRegistros &archivoRegistros, string nombre,
           int tamanioRegistro) {
...
/*----------------------------------------------------------------------------*/
void EjemploArchivoRegistros::destruir(ArchivoRegistros &archivoRegistros) {
...
/*----------------------------------------------------------------------------*/
void EjemploArchivoRegistros::escribir(ArchivoRegistros& archivoRegistros, const void* registro) {
...
/*----------------------------------------------------------------------------*/
void EjemploArchivoRegistros::leer(ArchivoRegistros& archivoRegistros, void* registro) {
...
/*----------------------------------------------------------------------------*/
bool EjemploArchivoRegistros::fin(ArchivoRegistros& archivoRegistros) {
...
/*----------------------------------------------------------------------------*/
long int EjemploArchivoRegistros::posicion(ArchivoRegistros& archivoRegistros) {
...
/*----------------------------------------------------------------------------*/
void EjemploArchivoRegistros::posicionarse(ArchivoRegistros& archivoRegistros, long int posicion) {
